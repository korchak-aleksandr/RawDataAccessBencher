...
namespace RawBencher.Benchers
{
    ...
    public class NHibernateNormalBencher : BencherBase<NH.Bencher.EntityClasses.SalesOrderHeader>
    {
        ...
        {
            //return SessionManager.Session.Get<NH.Bencher.EntityClasses.SalesOrderHeader>(key);
        ...
        {
            //return SessionManager.Session.Query<NH.Bencher.EntityClasses.SalesOrderHeader>().ToList();
        ...
        {
            //return SessionManager.Session.Query<NH.Bencher.EntityClasses.SalesOrderHeader>()
        ...
        {
            //return await SessionManager.Session.Query<NH.Bencher.EntityClasses.SalesOrderHeader>()
            //    .Where(soh => soh.SalesOrderId > 50000 && soh.SalesOrderId <= 51000)
            //    .Fetch(x => x.Customer)
            //    .Fetch(x => x.SalesOrderDetails)
            //    .ToListAsync();
